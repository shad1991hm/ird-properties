...
interface DataContextType {
  ...
  issueProperty: (requestId: string, storeManagerId: string, storeManagerName: string) => Promise<void>;
...
export const DataProvider: React.FC<DataProviderProps> = ({ children }) => {
  ...
  const issueProperty = async (requestId: string, storeManagerId: string, storeManagerName: string) => {
    try {
