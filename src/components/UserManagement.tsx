            ...
            return (
              <div key={user.id} className="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                <div className="p-6 xl:p-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 xl:gap-3">
                    <button
                    ...
                    >
                      <Edit className="w-4 h-4 xl:w-5 xl:h-5 mr-2" />
                      Edit
                    </button>
                    {user.id !== currentUser?.id && (
                      <button
                        onClick={() => handleDelete(user.id)}
                        className="flex-1 flex items-center justify-center px-3 py-2 xl:px-4 xl:py-3 text-sm xl:text-base font-medium text-red-600 bg-red-50 hover:bg-red-100 rounded-lg transition-colors"
                      >
