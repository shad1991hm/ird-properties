...
const AvailableProperties: React.FC = () => {
  ...
  const getAvailabilityStatus = (property: Property) => {
    ...
    if (percentage <= 10) return { status: 'Very Low', color: 'text-red-600 bg-red-50' };
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <span className={`inline-block px-2 py-1 text-xs font-medium rounded-full ${availabilityStatus.color}`}>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Serial: {property.serialNumber}</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">
                {availableProperties.reduce((sum, p) => sum + p.availableQuantity, 0)}
              </p>
            </div>
